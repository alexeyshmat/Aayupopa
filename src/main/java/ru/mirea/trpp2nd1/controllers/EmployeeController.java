package ru.mirea.trpp2nd1.controllers;
...
import ru.mirea.trpp2nd1.entity.Employee;
...
public class EmployeeController {
    ...
    public EmployeeController() {
        employeeList = new CsvToBeanBuilder<Employee>(new InputStreamReader
                (this.getClass().getResourceAsStream("/MOCK_DATA.csv"))).withType(Employee.class).build().parse();
    }
     ...
     */
    @Get("/{id}")
    public MutableHttpResponse<Object> findById(Long id) {
